powershell -Command "Set-Content -Encoding UTF8 src\app\onboarding\page.tsx @'
...
const steps = [
  {
    ...
    description: ""Go to analytics.google.com and sign in with your Google account. Click Start measuring, enter your account name, and follow the prompts to create a new GA4 property for your website."",
    link: { label: ""Open Google Analytics"", href: ""https://analytics.google.com"" },
  },
  {
    number: ""02"",
    title: ""Add the Tracking Code to Your Website"",
    description: ""Once your GA4 property is created, Google will give you a Measurement ID (G-XXXXXXXXXX) and a code snippet. Paste this into the head section of every page on your site. If you use WordPress, Wix, or Squarespace, there is a built-in field for this."",
    link: { label: ""How to add GA4 to your site"", href: ""https://support.google.com/analytics/answer/9304153"" },
  },
  {
    number: ""03"",
      ...
      <div className=""relative z-10 max-w-3xl mx-auto px-4 md:px-8 py-16"">
        ...
        <div className=""rounded-2xl p-8"" style={{ background: ""linear-gradient(135deg, rgba(230,184,32,0.08), rgba(230,184,32,0.04))"", border: ""1px solid rgba(230,184,32,0.2)"" }}>
          ...
          <div className=""flex flex-col sm:flex-row gap-3"">
            <a href={mailtoLink} className=""flex-1 text-center font-bold px-6 py-3 rounded-xl text-sm"" style={{ background: ""#e6b820"", color: ""#0a1530"" }}>Contact Us for Help</a>
